    ...
    public class Lift {
        ...
        public class TopCone implements Action{
            ...
            public boolean run(@NonNull TelemetryPacket packet){
                ...
                claw.setPosition(0);
                sleep(300);
                while (slide1.getCurrentPosition() <145 && slide2.getCurrentPosition() <145){
                    double slide1power;
                    // Calculates amount of ticks off slide1 is from target
                    double error1=-(170-slide1.getCurrentPosition()); // Error is negative because slide1 needs to reverse direction
                    ...
                    double error2=170-slide2.getCurrentPosition();
                ...
                sleep(1000);
                while (slide1.getCurrentPosition() >120 && slide2.getCurrentPosition() >120){

                    double slide1power;
                    // Calculates amount of ticks off slide1 is from target
                    double error1=-(100-slide1.getCurrentPosition()); // Error is negative because slide1 needs to reverse direction
                    ...
                    // Calculates amount of ticks off slide2 is from target
                    double error2=100-slide2.getCurrentPosition();
