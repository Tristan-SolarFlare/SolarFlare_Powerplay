...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -5369.576342554803; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 5424.641524797851; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 4159.735477556444; // x position of the perpendicular encoder (in tick units)
    }
