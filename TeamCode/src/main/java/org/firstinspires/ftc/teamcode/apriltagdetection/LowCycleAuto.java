...
public class LowCycleAuto extends LinearOpMode {
    OpenCvCamera camera;
    ...
    public class LowJunction implements Action{
    ...
    public void runOpMode(){
        ...
        Action ParkZone1 = drive.actionBuilder(new Pose2d(55,38,Math.toRadians(120)))
                .turn(Math.toRadians(-120))
                .strafeTo(new Vector2d(36,36))
                .strafeTo(new Vector2d(36,60))
                .build();

        Action ParkZone2 = drive.actionBuilder(new Pose2d(55,38,Math.toRadians(120)))
                .turn(Math.toRadians(-120))
                .build();

        Action ParkZone3 = drive.actionBuilder(new Pose2d(55,38,Math.toRadians(120)))
                .turn(Math.toRadians(-120))
                .strafeTo(new Vector2d(36,36))
        ...
        LowCycleAuto lc = new LowCycleAuto();
